        ...
        <section className='bg-sign flex justify-center items-center pt-20 pb-20'>
           <div className='bg-[white] h-[790px] w-[43%] shadow-lg shadow-black rounded-3xl'>
            ...
            <div className='ml-[75px] mt-[38px]'>
              ...
              <input type="email" className='w-[85%] h-[50px] bg-[#F3F3F3] rounded-[4px] focus:outline-[#623ECA] hover:border-[2px] pl-2 text-[#67656E] text-[14px] font-semibold' placeholder='Enter email address'/>
