        ...
        <section className='bg-sign flex justify-center items-center pt-20 pb-20'>
           <div className='bg-[white] h-[790px] w-[43%] shadow-lg shadow-black rounded-3xl'>
            ...
            <div className='ml-[75px] mt-[38px]'>
              ...
              <input type="text" className='w-[85%] h-[50px] bg-[#F3F3F3] rounded-[4px] focus:outline-[#623ECA] hover:border-[2px] pl-2 text-[#67656E] text-[14px] font-semibold' placeholder='Enter your firstname'/>
              <label htmlFor="Lastname" className='block text-[14px] text-[#67656E] font-apple font-medium mt-5'>Lastname</label>
              <input type="text" className='w-[85%] h-[50px] bg-[#F3F3F3] rounded-[4px] focus:outline-[#623ECA] hover:border-[2px] pl-2 text-[#67656E] text-[14px] font-semibold' placeholder='Enter your lastname'/>
              <label htmlFor="Email" className='block text-[14px] text-[#67656E] font-apple font-medium mt-5'>Email</label>
              <input type="email" className='w-[85%] h-[50px] bg-[#F3F3F3] rounded-[4px] focus:outline-[#623ECA] hover:border-[2px] pl-2 text-[#67656E] text-[14px] font-semibold' placeholder='email must be valid'/>
              <button className='block mt-[35px] w-[85%] h-[55px] bg-[#623ECA] rounded-[4px] text-[#FFFFFF] text-[18px] font-semibold font-sans'>Proceed</button>
            </div>
