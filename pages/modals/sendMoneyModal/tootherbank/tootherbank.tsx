...
const ToOtherBank:React.FC<ModalProps> = ({isOpen,onClose,setOthers, pinOpen,setpinOpen}) => {
    ...
    <>
      ...
      <div className='fixed inset-0 flex items-center justify-center z-50'>
       ...
       <h3 className='text-[30px] font-medium mb-4'>Send Money To</h3>
         ...
         <button className='block mt-[15px] lg:w-[70%] md:w-[70%] w-[75%] h-[55px] bg-[#623ECA] rounded-[4px] text-[#FFFFFF] text-[18px] font-semibold font-sans' onClick={proceed}>Proceed</button>
         </div>
         </div>
     </div>
    </>
