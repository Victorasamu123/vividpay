    ...
    <>
     ...
     <title>Vividpay</title>
      ...
      <main>
        ...
        <div id='two' className='lg:mt-[2%] lg:w-[53%] lg:ml-[2.3%] md:mt-[2%] md:w-[95%] md:ml-[5%] mt-[2%] w-[95%] ml-[5%]'>
          <div className='lg:flex md:flex block'>
            {/* Available balance */}
           <div className='lg:bg-[#FFFFFF] lg:w-[32%] lg:h-[100px] lg:rounded-md lg:shadow md:bg-[#FFFFFF] md:w-[26%] md:h-[100px] md:rounded-md md:shadow bg-[#FFFFFF] w-[95%] h-[100px] rounded-md shadow pt-1 lg:pt-0 md:pt-0'>
          ...
          {/*Transactio history */}
          <div className='lg:w-[100%] lg:h-[250px] lg:bg-[#FFFFFF] lg:shadow lg:rounded-xl lg:mt-10 lg:pt-[27px] lg:pl-4 lg:pr-4 md:w-[95%] md:h-[250px] md:bg-[#FFFFFF] md:shadow md:rounded-xl md:mt-10 md:pt-[27px] md:pl-4 md:pr-4 w-[95%] h-[250px] bg-[#FFFFFF] shadow rounded-xl mt-10 pt-[27px] pl-4 pr-4'>
